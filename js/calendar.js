...
function initCalendar() {
    ...
    const isMobile = window.innerWidth < 768; // فحص الشاشة

    calendar = new FullCalendar.Calendar(calendarEl, {
        initialView: isMobile ? 'timeGridDay' : 'timeGridWeek', // عرض يوم واحد في الموبايل
    ...
    db.collection("Appointments")
      ...
      .onSnapshot(snap => {
        ...
        snap.forEach(doc => {
            ...
            calendar.addEvent({
                id: doc.id,
                title: `${data.patientName}`, // إخفاء النوع لتوفير مساحة الموبايل
                start: startDateTime,
